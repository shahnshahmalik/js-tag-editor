function TagEdit(container, inputEl, closeBtnHtml = 'x') {
  /**
   ...
   * @returns element
   */
  this.createTagItem = (tagName, closeIconHtml = null) => {
